...
infix fun <T> Spek<T, Boolean>.and(
    other: Spek<T, Boolean>
) = BinaryOperationSpek(this, other) { a, b -> a() && b() }
infix fun <T> Spek<T, Boolean>.andNot(
    other: Spek<T, Boolean>
) = BinaryOperationSpek(this, other) { a, b -> a() && !b() }
infix fun <T> Spek<T, Boolean>.or(
    other: Spek<T, Boolean>
) = BinaryOperationSpek(this, other) { a, b -> a() || b() }
infix fun <T> Spek<T, Boolean>.orNot(
    other: Spek<T, Boolean>
) = BinaryOperationSpek(this, other) { a, b -> a() || !b() }
